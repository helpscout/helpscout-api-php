    ...
    public function getObjectVars()
    {
        ...
        if ($this->getType() == null) {
            if ($this instanceof \HelpScout\model\thread\Customer) {
                $this->type = 'customer';
            } elseif ($this instanceof \HelpScout\model\thread\Message) {
                $this->type = 'message';
            } elseif ($this instanceof \HelpScout\model\thread\Note) {
                $this->type = 'note';
            } elseif ($this instanceof \HelpScout\model\thread\Chat) {
                $this->type = 'chat';
            } elseif ($this instanceof \HelpScout\model\thread\Phone) {
                $this->type = 'phone';
            } elseif ($this instanceof \HelpScout\model\thread\ForwardChild) {
                $this->type = 'forwardchild';
            } elseif ($this instanceof \HelpScout\model\thread\ForwardParent) {
